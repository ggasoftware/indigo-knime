...
public class IndigoSubstructureMatchCounterNodeFactory extends
      NodeFactory<IndigoSubstructureMatchCounterNodeModel>
{
    ...
    */
   @Override
   public NodeView<IndigoSubstructureMatchCounterNodeModel> createNodeView (
         final int viewIndex,
