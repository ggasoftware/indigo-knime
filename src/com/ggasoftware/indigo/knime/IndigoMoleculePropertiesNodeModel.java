...
public class IndigoMoleculePropertiesNodeModel extends NodeModel {
    ...
    static
    {
    	...
    	calculators.put("Number of connected components", new IntPropertyCalculator () {
    		public DataCell calculate (IndigoObject io)
    	...
    	calculators.put("Hydrogen count", new IntPropertyCalculator () {
    		public DataCell calculate (IndigoObject io)
    		{ return new IntCell(io.countAtoms() - io.countHeavyAtoms()); }});*/
    ...
    {
    	DataColumnSpec[] specs = new DataColumnSpec[inSpec.getNumColumns() + m_settings.selectedProps.length]; 
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
	  ...
	  while (it.hasNext())
	  {
		  ...
		  DataCell[] cells = new DataCell[inputRow.getNumCells() + m_settings.selectedProps.length];
