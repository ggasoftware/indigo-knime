...
public class IndigoValueRenderer extends AbstractPainterDataValueRenderer {
    ...
    private static final NodeLogger LOGGER =
            NodeLogger.getLogger(IndigoValueRenderer.class);
    ...
    private static IndigoRenderer renderer = new IndigoRenderer(IndigoCell.indigo);
    ...
    protected void setValue(final Object value) {
        if (value instanceof IndigoValue) { // when used directly on CDKCell
        	_object = ((IndigoValue)value).getIndigoObject();
        }
        else if (value instanceof SmilesValue)
        {
        	_object = IndigoCell.indigo.loadMolecule(((SmilesValue)value).getSmilesValue());
        }
        else if (value instanceof MolValue)
        {
        	_object = IndigoCell.indigo.loadMolecule(((MolValue)value).getMolValue());
        }
        else if (value instanceof SdfValue)
        {
        	_object = IndigoCell.indigo.loadMolecule(((SdfValue)value).getSdfValue());
        }
    }
