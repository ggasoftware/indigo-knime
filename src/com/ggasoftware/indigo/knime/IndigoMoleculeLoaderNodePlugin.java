 ...
 */
public class IndigoMoleculeLoaderNodePlugin extends Plugin {
    // The shared instance.
    private static IndigoMoleculeLoaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public IndigoMoleculeLoaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static IndigoMoleculeLoaderNodePlugin getDefault() {
        return plugin;
    }
