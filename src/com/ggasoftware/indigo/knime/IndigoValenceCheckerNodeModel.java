...
public class IndigoValenceCheckerNodeModel extends NodeModel {
    ...
    private static final NodeLogger logger = NodeLogger
            .getLogger(IndigoValenceCheckerNodeModel.class);
    ...
    protected DataTableSpec[] getDataTableSpecs (DataTableSpec inputTableSpec) throws InvalidSettingsException
    {
	  ...
	  DataColumnSpec invalidOutputColumnSpec = new DataColumnSpecCreator(m_settings.colName, StringCell.TYPE).createSpec();
	  DataColumnSpec[] invalidOutputColumnSpecs= new DataColumnSpec[inputTableSpec.getNumColumns()];
	  ...
	  return new DataTableSpec[]{inputTableSpec, new DataTableSpec(invalidOutputColumnSpecs)};
    }
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData,
    	...
    	DataTableSpec[] outputSpecs = getDataTableSpecs(inputTableSpec);
    	  ...
    	  while (it.hasNext())
    	  {
			  ...
			  String str = ((IndigoCell)(inputRow.getCell(colIdx))).getIndigoObject().checkBadValence();
